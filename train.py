        ...
        try:
            ...
            for e in range(1, num_epochs + 1):
                ...
                for i in range(input_cs.NUM_EX_TRAIN // batch_size):
                    ...
                    summary, _, curr_train_loss = sess.run([merged_summary, train_op, cross_ent_mean], feed_dict={images: img, labels: lbl})

                    if i % 10 == 0:
                        logging.info("Train step: {}/{}, loss: {}".format((global_step.eval() - 1) % n_steps, n_steps, curr_train_loss))
                ...
                if e % validate_every == 0:
                    ...
                    try:
                        ...
                        while True:
                            ...
                            out_cross_ent, out_logits, labels_val = sess.run([cross_ent, logits, labels], feed_dict={images: img, labels: lbl})
